...
export default function Account() {
  ...
  const getAlertStats = (fraudTxns: number) => {
    if (fraudTxns >= 3)
      return { label: "Alert", class: "bg-red-100 text-red-800" };
    if (fraudTxns >= 1)
      return { label: "Under review", class: "bg-yellow-100 text-yellow-800" };
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm">
                      <span
                        className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full ${alert.class}`}
                      >
                        {alert.label}
                      </span>
                      {acc.fraudTxns > 0 && (
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <Link
                        href={`/dashboard/accounts/${acc.accountId}`}
